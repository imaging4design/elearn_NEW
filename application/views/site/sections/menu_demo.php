	...
	<div class="container">
		<div class="row">
			<div class="col-sm-9 col-full">
				...
				<h2>Free Demo Tour ...</h2>
				<div class="multiseparator vc_custom"></div>

				<p>Click on one of the bolded topics which will take you through to the key notes of that topic. You can also view audio videos, flash cards and the written answers section by clicking the various tabs on the toolbar. This will give you an insight into the site as a student. An individual licence allows you to track your progress and see reports. For more information on the depth of the site, see the downloadable brochure on the home page.</p>
				<p>We are happy to answer any questions. </p>
					<?php echo safe_mailto('info@elearneconomics.com', 'Contact Us', array('class'=>'btn btn-md btn-red')); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
						...
						<h2>Course Topics <small>- Select any <span class="text-redLight">(demo)</span> topic for a free sample</small></h2>
						<div class=	"multiseparator vc_custom"></div>
