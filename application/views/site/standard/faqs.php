						...
						foreach($faqs as $row):
							...
							echo '<div class="panel panel-default">';
								echo '<div class="panel-heading" role="tab" id="item-'.$counter.'">';
									echo '<p class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-'.$counter.'" aria-expanded="true" aria-controls="collapse-'.$counter.'"><span class="text-red"><i class="fa fa-plus"></i></span> &nbsp;' . $row->question . '</a></p>';
								echo '</div>';
